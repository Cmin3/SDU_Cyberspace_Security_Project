# 基于DDH的隐私保护集合交集求和协议实现

## 一、项目概述

本项目实现了基于判定性迪菲-赫尔曼问题(DDH)的隐私保护集合交集求和协议，允许协议双方(P1和P2)在不泄露各自原始数据的情况下，安全计算出双方数据集交集中元素的关联值之和。

## 二. DDH-based Private Intersection-Sum 协议详细分析
...
协议执行完毕
---
P1的原始数据：{'banana', 'cherry', 'apple', 'date'}
P2的原始数据：{'apple': 100, 'cherry': 300, 'fig': 500, 'grape': 250}
期望的交集和：400
协议计算出的交集和：400
